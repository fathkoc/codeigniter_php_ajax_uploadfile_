...
class What_we extends Veripay_Controller
{
   ...
   public function index()
   {
       ...
       $this->load->view('admin/what_we/list');
    ...
    public function update($id = '')
    {
        ...
        if(empty($id)) {
            redirect(site_url('yonetim-paneli/neler-yapiyoruz'));
        }
        $this->admin_logout();
        $admin_info = $this->get_user();
        $data = new stdClass();
        ...
        $data->what_we = $this->model->get_selected_what_we($id);
        ...
        if ($this->form_validation->run() != false) {
            ...
            if ($this->model->update($post_data,$id)) {
                $this->result->url = site_url('yonetim-paneli/neler-yapiyoruz');
        ...
        $this->load->view('admin/header', $data);
        $this->load->view('admin/what_we/update');
        $this->load->view('admin/footer');
    }
